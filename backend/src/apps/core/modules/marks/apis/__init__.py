...
urlpatterns = [
    ...
    path('assignments/<int:assignment_id>/marks-list', assignment_marks.AssignmentMarksListCreateAPI.as_view(), name='assignment-marks-list'),
    path('assignments/<int:assignment_id>/marks', assignment_marks.EnrollmentsAssignmentMarksListAPI.as_view(), name='assignment-marks'),
