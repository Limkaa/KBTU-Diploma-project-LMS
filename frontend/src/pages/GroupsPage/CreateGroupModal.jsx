...
const CreateGroupModal = ({show, setShow, refetch}) => {
    ...
    const {data: grades} = useGetSchoolGradesWithoutPageQuery({school_id: user.school_id});
                            ...
                            {({ field, form: { touched, errors } }) => (
                                <>
                                    <InputStyled
                                        ...
                                        size="small"
                                    />
                                    <div className={touched[field.name] && errors[field.name] ? "error" : "hidden"}>
                                        {errors[field.name]}
                                    </div>
                                </>
                            )}
