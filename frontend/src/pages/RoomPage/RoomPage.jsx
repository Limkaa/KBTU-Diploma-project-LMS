      ...
      <section>
        <div className="inputs">
          <div>
            ...
            >
              <Radio.Button className="radio" value={"name"}>
                Name
              </Radio.Button>
              <Radio.Button className="radio" value={"created_at"}>
                Creation
              </Radio.Button>
              <Radio.Button className="radio" value={"updated_at"}>
                Update
              </Radio.Button>
            </Radio.Group>
          </div>
            ...
            {rooms.map((room) => (
              ...
              >
                <div className="card-content">
                  ...
                  {room.is_active ? (
                    <Tag
                      style={{ minWidth: 60, textAlign: "center", margin: 0 }}
                      color="green"
                    >
                      active
                    </Tag>
