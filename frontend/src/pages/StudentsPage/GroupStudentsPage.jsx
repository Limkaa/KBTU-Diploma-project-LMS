...
const GroupStudentsPage = () => {
  ...
  const columns = [
    ...
    },
    {
      title: "Email",
      key: "email",
      render: (student) => <span>{student.user.email}</span>,
    },
    {
      title: "Gender",
      key: "gender",
    ...
    },
    {
      ...
      key: "rating",
      width: "15%",
      render: (student) => <span>{student.user.rating}</span>,
    },
  ];
          ...
          <div className="group-info">
            <Spin spinning={isGroupLoading}>
              ...
              <div className="card">
                ...
                <div
                  className={
                    group?.grade?.is_active ? "flex green" : "flex red"
                  }
                >
                  <div className="head">
                    <h4>Grade</h4>
                  ...
                  <div className="info">
                    ...
                    <p>{group?.grade?.is_active ? "active" : "inactive"}</p>
                  </div>
                </div>
